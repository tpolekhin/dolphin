                                            ...
                                            u32 dst_layer, u32 dst_level)
{
  ...
  DEBUG_ASSERT(src_rect.GetWidth() == dst_rect.GetWidth() &&
               src_rect.GetHeight() == dst_rect.GetHeight());
  DEBUG_ASSERT(src_rect.left >= 0 && src_rect.top >= 0 && dst_rect.left >= 0 && dst_rect.top >= 0);
...
{
  DEBUG_ASSERT(source->GetConfig().rendertarget);
                        ...
                        size_t buffer_size)
{
  ...
  DEBUG_ASSERT(level < m_config.levels && width > 0 && height > 0);
  ...
  DEBUG_ASSERT(buffer_size >= upload_size);

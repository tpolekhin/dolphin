                                       ...
                                       const CopyFilterCoefficientArray& filter_coefficients)
{
  ...
  DEBUG_ASSERT(tex->HasFramebuffer());
  ...
  g_renderer->DrawUtilityPipeline(&uniforms, sizeof(uniforms), vertices.data(),
                                  sizeof(VideoCommon::UtilityVertex),
                                  static_cast<u32>(vertices.size()));
  g_renderer->RestoreAPIState();
}

void TextureCache::CopyEFB(AbstractStagingTexture* dst, const EFBCopyParams& params, u32 native_width,
